...
### Choose a profile picture and input your name

![image2][image2]

You can also change the name and profile picture when you reset the user
...
* `Activities` were used to create all the pages.
* `Intent` is used to navigate between activities.
* `Local Storage` is implemented to save username, profile picture and scores throughout the app.
* `Progress Bars` are used to show what question the user is at.
* `Premissions` are used to access the gallery to choos a profile picture.
...
#### Design Architecture
`Activities` to design the pages used in Kidcelence.

#### Highlights

* One highlight was to `research` a new age gap and design around it.
* The `UI/UX design` was to help children improve their Cognitive and Sensory awareness skills.
* The best part was to load the app onto a `real device`.
* `Finishing` the project brief in time of the `deadline`.

#### Challenges

* Was a challenge to get the profile picture feature to work.
